...
public class _05_TryWithResources {
    public static void main(String[] args) {
        ...
        try (MyFileWriter writer2 = new MyFileWriter()) {  // Try with resources (AutoCloseable을 구현해줘야함)
            writer2.write("빵이 먹고 싶어요");
        } catch (Exception e) {
            e.printStackTrace();
        }

        BufferedWriter bw = null;  // BufferedWriter는 Writer를 상속받았으며, Writer는 AutoCloseable을 구현한 추상 클래스
    }
}
